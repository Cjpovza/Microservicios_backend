...
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Microservicio Suma',
      version: '1.0.0',
      description: 'Realiza la operación de suma y registra los resultados',
    },
 ...
 * tags:
 *   - name: Suma
 *     description: Métodos de suma usando distintos tipos de parámetros
 */
 ...
 *   get:
 *     tags: [Suma]
 *     summary: Suma dos números mediante Path Params
 *     parameters:
 *       - in: path
 *         name: dato1
 *         required: true
 ...
 *   get:
 *     tags: [Suma]
 *     summary: Suma dos números mediante Query Params
 *     parameters:
 *       - in: query
 *         name: dato1
 *         required: true
 ...
 *   post:
 *     tags: [Suma]
 *     summary: Suma dos números mediante Body Params
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
async function notificarRegistro(payload) {
  try {
    ...
    console.log('Registro insertado correctamente desde /suma');
  } catch (err) {
...
// PATH params: /operacion/:dato1/:dato2
app.get('/suma/:dato1/:dato2', async (req, res) => {
...
// QUERY params: /operacion?dato1=10&dato2=5
